...
def test_load(model_name):
    ...
    # THE FIX: Separate Real (DataKeeper) from NSE (Standalone)
    ...
    if empirical:
        ...
        while j < sim:
            # Pass 'is_nse' so env_nse knows to trigger the real-world testing block!
...
if __name__ == '__main__':
    ...
    if args['test']:
        print(f'Testing model {args["model"]} in NSE Mode')
