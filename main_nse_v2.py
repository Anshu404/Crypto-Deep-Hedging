...
# ==========================================
# STRICT ISOLATION: Load the Indian Equity Environment & Testing (V2)
# ==========================================
from include.env_nse_v2 import Env
from testing_nse_v2 import test_run  # <-- Changed to testing_nse_v2 to keep pipeline pure
...
def main(model_name = None):
    ...
    if model_name is None:
        ...
        # Ensure we are strictly using the NSE_V2 process
        process = 'NSE_V2' 
        settings['process'] = 'NSE_V2'
    ...
    print(f'Training model {model_name} in NSE_V2 (Indian Equity) Mode')
    ...
    # Initialize the NSE_V2 Environment
    env = Env(settings)
...
if __name__ == "__main__":
    ...
    # Default to loading the Nse_V2 settings JSON
    p.add_argument('--settings', required=False, default='Nse_V2')
